...
@api
Functionaliteit: leveren indicatie veel bewoners bij het raadplegen van bewoning op peildatum
...
Regel: indicatieVeelBewoners wordt geleverd wanneer er op een peildatum meer dan 100 bewoners zijn
