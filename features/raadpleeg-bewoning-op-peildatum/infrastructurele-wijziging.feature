...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object wanneer de peildatum valt vóór datum toevoeging van BAG identificaties
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is overgegaan in een samenvoeging als de peildatum op of na datum samenvoeging ligt
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is ontstaan uit een samenvoeging als de peildatum vóór datum samenvoeging ligt
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is gesplitst en de peildatum ligt op of na datum splitsing
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is ontstaan uit een splitsing en de peildatum ligt vóór datum splitsing
