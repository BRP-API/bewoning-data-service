...
Een mogelijke bewoner is een persoon die (voor een deel) van de gevraagde periode in de onzekerheidsperiode van de gevraagde adreshouding valt.
  ...
  Regel: Binnen een bewoning samenstelling worden de mogelijke bewoners in een vaste volgorde gesorteerd.
   De sortering gebeurt op basis van de volgende criteria, in deze volgorde:
    ...
    @valideer-volgorde
    Scenario: De mogelijke bewoners worden gesorteerd op geslachtsnaam als datum aanvang adreshouding overeenkomt
