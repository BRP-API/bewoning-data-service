...
Functionaliteit: Elke wijziging van de samenstelling van bewoners van een adresseerbaar object leidt tot een bewoning
  ...
  Regel: er wordt geen bewoning geleverd zonder bewoners of mogelijke bewoners
  ...
  Regel: datumTot van een periode bevat de bewoning tot en met 1 dag vóór datumTot en is minimaal 1 dag later dan datumVan
  ...
  Regel: meerdere aaneensluitende verblijfplaatsen op hetzelfde adresseerbaar object, met dezelfde (mede)bewoners, wordt als één bewoning geleverd
