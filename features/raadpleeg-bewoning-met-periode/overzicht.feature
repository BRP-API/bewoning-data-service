...
Regel: Een persoon die verblijft op het gevraagde adresseerbaar object met een bekende datum aanvang adreshouding is bewoner in (een deel van) de gevraagde periode als (dat deel van) de gevraagde periode in de adreshoudingperiode ligt
...
Regel: Voor een periode worden meerdere bewoningen geleverd als de samenstelling van bewoners in de periode is veranderd
...
Regel: Voor een (deel van de) periode wordt geen bewoning geleverd als er binnen (dat deel van) de periode geen personen verblijven/hebben verbleven op het adresseerbaar object
...
Regel: Een persoon met een afgevoerde persoonslijst of logisch verwijderde persoonslijst wordt niet gezien als bewoner
...
Regel: Een persoon met opschorting bijhouding wordt na datum opschorting bijhouding niet gezien als bewoner
...
Regel: Een persoon met geheel/deels onbekende datum aanvang adreshouding is mogelijke bewoner in (een deel van) de gevraagde periode als (dat deel van) de gevraagde periode in de onzekerheidsperiode van de adreshouding ligt
...
Regel: Een persoon met geheel/deels onbekend datum aanvang adreshouding en bekende datum aanvang volgende adreshouding, is mogelijke bewoner in (een deel van) de gevraagde periode als (dat deel van) de gevraagde periode in de onzekerheidsperiode van de adreshouding vóór datum aanvang volgende adreshouding ligt
...
Regel: Een persoon met bekende datum aanvang adreshouding en geheel/deels onbekende datum aanvang volgende adreshouding, is mogelijke bewoner in (een deel van) de gevraagde periode als (dat deel van) de gevraagde periode in de onzekerheidsperiode van de volgende adreshouding na datum aanvang adreshouding ligt
...
Regel: Een persoon met geheel/deels onbekende datum aanvang adreshouding, geheel/deels onbekende datum aanvang volgende adreshouding en een bekende datum aanvang vorige adreshouding die in de onzekerheidsperiode ligt, is mogelijke bewoner in (een deel van) de gevraagde periode als (dat deel van) de gevraagde periode in één van de onzekerheidsperiodes ná datum aanvang vorige adreshouding ligt 
...
Regel: Een persoon met deels onbekend datum aanvang adreshouding, deels onbekend datum aanvang vorige adreshouding waarvan de onzekerheidsperiodes niet overlappen, is mogelijke bewoner in (een deel van) de gevraagde periode als (dat deel van) de gevraagde periode in de onzekerheidsperiode van de adreshouding ligt
