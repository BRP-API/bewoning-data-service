...
Functionaliteit: gebeurtenissen met meerdere bewoners in periode met geheel of gedeeltelijk onbekende datums
  ...
  Regel: Bij de start en na afloop van de onzekerheidsperiode van datum aanvang volgende verblijfplaats ontstaat een nieuwe bewoning(samenstelling), tenzij deze periodes overlappen of direct op elkaar aansluiten
  ...
  Regel: Als de bijhouding van de persoon tijdens de onzekerheidsperiode wordt opgeschort, ontstaat op de datum opschorting een nieuwe bewoning(samenstelling)
