...
@api
Functionaliteit: raadpleeg bewoning in periode bij nevenadressen

Regel: een persoon ingeschreven op een nevenadres wordt gezien als bewoner van het hoofdadres
