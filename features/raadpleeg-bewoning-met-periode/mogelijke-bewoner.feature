...
Regel: een persoon die verblijft op het gevraagde adresseerbaar object met onbekende aanvang adreshouding, geen vorige en volgende adreshouding, is in een periode een mogelijke bewoner voor dat deel van de periode die in de onzekerheidsperiode van de gevraagde adreshouding ligt
...
Regel: een persoon met onbekende aanvang adreshouding, en een bekende datum volgende adreshouding die na de onzekerheidsperiode van de gevraagde adreshouding ligt, is een mogelijke bewoner voor dat deel van de periode dat binnen de onzekerheidsperiode van de gevraagde adreshouding ligt
...
Regel: een persoon met bekende aanvang volgende adreshouding die in de onzekerheidsperiode van de onbekende aanvang adreshouding ligt, is een mogelijke bewoner voor dat deel van de periode dat in de onzekerheidsperiode vóór de datum aanvang volgende adreshouding ligt 
...
Regel: een persoon met bekende aanvang adreshouding die niet in de onzekerheidsperiode van de deels onbekende aanvang volgende adreshouding ligt, is mogelijke bewoner voor dat deel van de periode dat in de onzekerheidsperiode van het volgende adreshouding ligt
...
Regel: een persoon met deels onbekende aanvang adreshouding, deels onbekende aanvang volgende adreshouding en niet-overlappende onzekerheidsperiodes, is een mogelijke bewoner voor dat deel van de periode dat in één van de onzekerheidsperiodes ligt
...
Regel: een persoon met bekende aanvang adreshouding die in de onzekerheidsperiode van het deels/geheel onbekende volgende aanvang adreshouding ligt, is een mogelijke bewoner voor het deel van de periode dat in de onzekerheidsperiode na datum aanvang adreshouding ligt
  ...
  Abstract Scenario: datum aanvang adreshouding ligt in de onzekerheidsperiode van het deels/geheel onbekende aanvang volgende adreshouding en periode overlapt de onzekerheidsperiode
    Gegeven de persoon met burgerservicenummer '000000024' is ingeschreven op adres 'A1' met de volgende gegevens
    | gemeente van inschrijving (09.10) | datum aanvang adreshouding (10.30) |
    | 0800                              | 20100818                           |
    En de persoon is vervolgens ingeschreven op adres 'A2' met de volgende gegevens
...
Regel: een persoon met bekende aanvang vorige adreshouding die vóór de onzekerheidsperiode van deels onbekende aanvang adreshouding ligt, is een mogelijke bewoner voor het deel van de periode dat in de onzekerheidsperiode van de gevraagde adreshouding ligt
...
Regel: een persoon met bekende aanvang vorige adreshouding die in de onzekerheidsperiode van de onbekende aanvang adreshouding ligt, is een mogelijke bewoner voor het deel van de periode in de onzekerheidsperiode dat na de datum aanvang vorige adreshouding ligt
...
Regel: een persoon met deels onbekende aanvang adreshouding, deels onbekende aanvang vorige adreshouding en niet-overlappende onzekerheidsperiodes, is een mogelijke bewoner voor het deel van de periode dat in de onzekerheidsperiode van de gevraagde adreshouding ligt
...
Regel: een persoon met onbekende aanvang adreshouding, onbekende aanvang vorige adreshouding en gelijke onzekerheidsperiode, is een mogelijke bewoner voor het deel van de periode dat in de onzekerheidsperiode ligt
...
Regel: een persoon met onbekende aanvang adreshouding is bewoner voor dat deel van de periode dat na de onzekerheidsperiode van de gevraagde adreshouding ligt en voor de aanvang volgende verblijf
