...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object voor (het deel van) de gevraagde periode dat vóór datum toevoeging van BAG identificaties ligt
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is overgegaan in een samenvoeging voor (het deel van) de gevraagde periode dat op en na datum samenvoeging ligt
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is ontstaan uit een samenvoeging voor (het deel van) de gevraagde periode dat vóór datum samenvoeging ligt
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is gesplitst voor (het deel van) de gevraagde periode dat op en na datum splitsing ligt
...
Regel: bewoning wordt niet geleverd voor een adresseerbaar object dat is ontstaan uit een splitsing voor (het deel van) de gevraagde periode dat vóór datum splitsing ligt
