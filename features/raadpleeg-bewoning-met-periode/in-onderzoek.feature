...
Regel: het in onderzoek zijn van verblijfplaats gegevens wordt ongevraagd geleverd
...
Regel: datum ingang onderzoek is niet relevant voor het wel/niet leveren van 'in onderzoek' gegevens
...
Regel: een beëindigd onderzoek wordt niet geleverd, ook niet als de gevraagde periode in de onderzoek periode ligt of geheel/deels overlapt
