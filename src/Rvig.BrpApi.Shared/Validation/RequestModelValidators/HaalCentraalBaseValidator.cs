...
namespace Rvig.BrpApi.Shared.Validation.RequestModelValidators;
...
public abstract class HaalCentraalBaseValidator<T> : AbstractValidator<T> where T : class
{
	...
	protected const string _datePattern = @"^\d{4}-(?:0[1-9]|1[0-2])-(?:0[1-9]|[12]\d|3[01])$";
	protected const string _dateErrorMessage = "Waarde is geen geldige datum.";
	protected const string _booleanPattern = "true|false";
