...
namespace Test.Rvig.HaalCentraalApi.DeveloperTests
{
	...
	public class TestErrorResponseService
	{
		...
		private readonly IOptions<HaalcentraalApiOptions> _haalcentraalOptions = Options.Create(new HaalcentraalApiOptions
		{
			BrpHostName = "host"
		});
