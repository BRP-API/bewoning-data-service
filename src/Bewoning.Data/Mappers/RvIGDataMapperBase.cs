...
public class RvIGDataMapperBase
{
    ...
    protected virtual GbaInOnderzoek? MapGbaInOnderzoek(int? inOnderzoekAanduiding, int? inOnderzoekBeginDatum, int? inOnderzoekEindDatum)
    {
    ...
    protected static void MapGeboorteBeperkt(lo3_pl_persoon dbPersoon, GbaGeboorteBeperkt geboorte)
    {
    ...
    public GbaOpschortingBijhouding? MapOpschortingBijhouding(lo3_pl inschrijving)
    {
