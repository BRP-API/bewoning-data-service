...
namespace Rvig.Data.Bewoningen.Helpers;
...
public class DomeinTabellenHelper : IDomeinTabellenHelper
{
    ...
    {
        return GetOmschrijvingBaseTabel(code, _domeinTabellenRepo.GetAllLanden, _landen, _landenPredikatenLastMomentOfRetrieval, (datetime) => _landenPredikatenLastMomentOfRetrieval = datetime);
    }
    ...
    {
        return GetOmschrijvingBaseTabel(code, _domeinTabellenRepo.GetAllRedenOpnemenBeeindigenNationaliteit, _redenenOpnemenBeeindigenNationaliteit, _redenenOpnemenBeeindigenNationaliteitLastMomentOfRetrieval, (datetime) => _redenenOpnemenBeeindigenNationaliteitLastMomentOfRetrieval = datetime);
    }
    ...
    {
        return GetOmschrijvingBaseTabel(code, _domeinTabellenRepo.GetAllVerblijfstitels, _verblijfstitels, _verblijfstitelsLastMomentOfRetrieval, (datetime) => _verblijfstitelsLastMomentOfRetrieval = datetime);
    }

    public Task<string?> GetRniDeelnemerOmschrijving(int? code)
    {
        return GetOmschrijvingBaseTabel(code, _domeinTabellenRepo.GetAllRniDeelnemers, _rniDeelnemers, _rniDeelnemersLastMomentOfRetrieval, (datetime) => _rniDeelnemersLastMomentOfRetrieval = datetime);
    }
